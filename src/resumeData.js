let resumeData = {
    ...
    "aboutme":"My name is Leeroy Phili. I recently graduated from a Full Stack web developer program at the University of Toronto. I'm currently looking for my first job as a developer. In the last few months since graduation, I have been completing personal projects than can be seen on my github page. In an effort to further my knowledge on the subject and stay current with the latest frameworks updates, I continue to take a number of courses on udemy during my freetime. Although, I have no experience in the field, I believe my drive, passion and determination about software developement can provide a fresh take on every project. I like new challenges and always open to constructive feedback. I am a quick learner and can comfortable adapt to any new environment . I am ready to use my skills and talent to be a team playeer to help build quality and highly function products.   ",
    "resume":"images/Leeroy-Phili-Resume.pdf",
    "projects":[
      {
        "name":"YoTixx ",
        "projectDiscription":"Inspired by the likes of ticketmaster, stubhub and many more ticketing apps. I challenged myself to build an app that was similar while implementing cool features such as price compare for the same or similar tickets sold  across multiple platforms. I used stubhub, Ticketmaster and Gametime web Api  to fetch data needed. For user authenticatication I used firebase Auth to enable each user to signup/signin to access other cool features like view current tickets, or change some privacy settings in the app. Overall the app has a lot potential also displays a deep knowledge of ReactNative",
      ...
      },
      {
        ...
        "projectDiscription":" This was one of my first mobile application. This app was built using expo for the purposes of understanding and learning more about react native. This app let user track their routes using maps, logged in users have the ability record and save each route track with their own custom track name.  All route tracks will be saved on the Mongo Database.  Each time a user logs in they have the ability to view the previous saved tracks. This was a fun knowledgable project. At the end of the project I had great understanding of React Native navigation and more familiarity with React hooks such as useContext and more  ",
      ...
      {
        "name":"Eat Da Burger",
        "projectDiscription":"Eat-Da-Burger! is a restaurant app that lets users input the names of burgers they'd like to eat. Whenever a user submits a burger name, the app will display the burger on the left side of the page waiting to be devoured. Each burger in the waiting area also has a Devour it! button. When the user clicks(devours the burger), the burger will move to the right side of the page which indicates the burgers has been devoured, a user can devour as many burgers as they want.   All the burgers are stored in MySql database, whether devoured or not.",
